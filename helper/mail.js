...
exports.verifiedEmailTemplate = () => {
    ...
    <div style="margin:50px auto;width:70%;padding:20px 0">
      ...
      <p style="font-size:1.1em">Hi,</p>
      <p>Thank you for choosing our App. your account has been </p>
      <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">VERIFIED</h2>
      <p style="font-size:0.9em;">Regards,<br />Jay Patel</p>
      <hr style="border:none;border-top:1px solid #eee" />
    </div>
  </div>`
